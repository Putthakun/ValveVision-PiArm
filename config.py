...
# J1=85, J2=44 หาจากการทดลองจริง (2026-08) โดยกวาดค่าแล้ววัดตำแหน่งดุมในภาพ
# เป็นค่าที่กล้องที่มือเห็นวงจุ๊บครบทั้ง 12 ตำแหน่งนาฬิกา และล้ออยู่กลางเฟรม
#   J1 น้อยลง = กล้องแพนไปทางที่ทำให้ล้อเลื่อนขวา (90→595px, 85→654px, กลางเฟรม=640)
#   J2 มากขึ้น = กล้องก้มลง  ·  J2 น้อยลง = เงยขึ้น
#   ★ J2=46 คือขีดจำกัด — เกินนั้น 12 นาฬิกาหลุดขอบบน
#
