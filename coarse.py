...
# ★ เคยลองเว้นระยะก่อนถึงจุ๊บจริง (120mm แล้วลดเหลือ 60mm) ด้วยเหตุผลว่ากล้อง
#   โฟกัสใกล้กว่า ~12 ซม.ไม่ได้ (2026-09) แต่พบว่า "ยิ่งเว้น ยิ่งบังคับให้ pitch
#   ต้องสุดขั้วกว่าที่ควร" เพราะการหักจาก r ตรงๆ เปลี่ยนรูปทรงเรขาคณิตที่แขนต้อง
#   ทำ — เช็คแล้วที่ 7 นาฬิกา standoff 60mm เหลือ pitch ให้เลือกแค่ +55/+60
#   (margin สูงสุด 19) เทียบกับไม่มี standoff เลยที่มี pitch ให้เลือกเยอะกว่า
#   (-10,+35,+40,+45,+50) margin ดีสุดถึง 31 ที่ +45 — และ pitch สุดขั้ว (+60)
#   ทำให้กล้องเล็งลงพื้นแทนที่จะเล็งไปที่ล้อ (เจอจริงจากภาพ 7 นาฬิกา)
#
#   Task 9 (ไม่มี standoff) เคยพิสูจน์แล้วว่าทุกตำแหน่งนาฬิกาเห็นจุ๊บชัดเจนหมด
#   ส่วนสมมติฐาน "กล้องโฟกัสใกล้ไม่ได้" ไม่เคยพิสูจน์จริงเลย จึงเอาออกก่อน
#   ให้ fine.py (nudge ทีละนิด gain=0.5) เป็นตัวคุมความแม่นยำแทน
STANDOFF_MM = 0.0
