...
ต่อ 1 รอบ (คนตั้งไฟ + ขยับล้อ ~30 วิ):
  ท่าสแกน      →   6 ใบ   (ล้อทั้งวง · ขยับล้อเล็กน้อยในกรอบเส้นมาร์คระหว่างถ่าย)
  เข้าใกล้      →  25 ใบ   (กวาด 25 มุมมองรอบจุดที่คำนวณได้)
  ภาพลบ        →   3 ใบ   (เล็งไปรูระบายอากาศ/น็อตล้อ ที่ระยะใกล้)

12 ตำแหน่งนาฬิกา (ทุกชั่วโมงรอบวง) × 4 สภาพแสง = 48 รอบ
  → ท่าสแกน   48 ×  6 =   288 ใบ
  → เข้าใกล้   48 × 25 = 1,200 ใบ
  → ภาพลบ     48 ×  3 =   144 ใบ
                        ─────────
                        1,632 ใบ    คนลงแรงจริง ~25 นาที
