...
def test_มุม_3_และ_9_นาฬิกาอยู่คนละฝั่ง():
    ...
    ยืนยันทิศจากการทดสอบบนแขนจริง (2026-08): ตั้งจุ๊บไว้ 7 นาฬิกา ระบบเดิม
    ตีความเป็น 5 (ภาพสะท้อนข้ามแกน 12-6) จึงกลับเครื่องหมาย dx ในโค้ดแล้ว
    → จุ๊บทางขวาของดุมในภาพ (dx>0) ต้องเป็น 9 นาฬิกา ไม่ใช่ 3
    """
    c9 = _pixel_angle_to_clock(hub_xy=(640, 400), valve_xy=(840, 400))
    c3 = _pixel_angle_to_clock(hub_xy=(640, 400), valve_xy=(440, 400))
